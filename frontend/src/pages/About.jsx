       ...
       <Title title={"ABOUT"} title2={"US"}/>
          ...
          <div className="my-10 flex flex-col md:flex-row gap-16">
            ...
            <p>Forever was born out of a passion for innovation and a desire to revolutionize
               ...
               of products from the comfort of their homes.</p>
            <p>Since our inception, we've worked tirelessly to curate a diverse selection 
              ...
              From fashion and beauty to electronics and home essentials, we offer an extensive
               ...
               <b className="text-[#009e3e]">Our Mission</b>
               <p>Our mission at Forever is to empower customers with
                 choice, convenience, and confidence. We're dedicated 
                 to providing a seamless shopping experience that exceeds
                  ...
                  <Title title={"WHY"} title2={"CHOOSE US"}/>
                      </div>
                      <div className="flex flex-col md:flex-row text-sm mb-20">
                        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
                          <b className='text-[#009e3e]'>Quality Assurance:</b>
                          <p className=" text-black">We meticulously select 
                            and vet each product to ensure it meets our stringent quality standards.</p>
                            </div>
                            <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
                              <b className='text-[#009e3e]'>Convenience:</b>
                              ...
                              <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
                                <b className='text-[#009e3e]'>Exceptional Customer Service:</b>
