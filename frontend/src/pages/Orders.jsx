      ...
      <div>
        {
          ordersData.map((product, index)=>(
            <div key={index} className="py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <img src={product.images[0]} className='w-16 sm:w-20' alt="" />
              <div className="">
                <p className='sm:text-base font-medium'>{product.name}</p>
                <div className="flex flex-center gap-3 mt-2 text-base text-gray-700 ">
                ...
                <p>Payment: <span className='text-gray-400'>{product.paymentMethod}</span></p>
              </div>
              </div>
